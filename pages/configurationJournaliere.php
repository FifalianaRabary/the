...
<head>
    ...
    <link href="../assets/css/cssConfigurationJournaliere.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="container col-xs-12 col-md-12 col-sm-12 col-lg-12">
        ...
        <div class="formulaire col-xs-6 col-md-6 col-sm-6 col-lg-6">
            <h1 class="titre">Configurer:</h1>
            <form action="" method="get">
                <label for="poids_min">Poids minimal journalier:</label>
                <input type="number" name="poids_min" id="poids_min">
                <br>

                <label for="bonus">Pourcentage bonus:</label>
                <input type="number" name="bonus" id="bonus">
                <br>

                <label for="mallus">Pourcentage mallus:</label>
                <input type="number" name="mallus" id="mallus">
                <br>
